...
### [我的博客在这里 &rarr;](http://githubli97.github.io)
...
**[在这里预览模板 &rarr;](http://githubli97.github.io/huxblog-boilerplate/)**
...
* 解决了代码过长自动换行的bug,替换为横向滚动条。详情请见[issue#15](https://github.com/githubli97/githubli97.github.io/issues/15)
...
* 如果你喜欢我的这个博客模板，请在`githubli97.github.io`这个repository点个赞——右上角**star**一下。
...
# SNS settings      
github_username: githubli97     # 你的github账号
weibo_username: githubli97      # 你的微博账号，底部链接会自动更新的。
...
ga_domain: githubli97.github.io			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
标题底图是可以自己选的，看看几篇示例post你就知道如何设置了。在
  [issue #6 ](https://github.com/githubli97/githubli97.github.io/issues/6) 中我被问到：怎么样才能让标题底图好看呢？
...
我的博客标题是 **“hang.li Blog”** 但是我想要在搜索的时候显示 **“李航的博客 | hang.li Blog”** ，这个就需要SEO Title来定义了。
