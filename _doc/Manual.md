...
```yml
# Site settings
title: hang.li Blog             # title of your website
SEOTitle: hang.li Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: githubli97     # modify this account to yours
weibo_username: githubli97      # the footer woule be auto-updated.
...
For instance, [Hello 2015])(https://githubli97.github.io/2015/01/29/hello-2015/) has the front-matter of this:
...
1. a _text style_ header like [this](https://githubli97.github.io/2019/09/08/spacemacs-workflow/) with
...
![](http://githubli97.github.io/img/blog-sidebar.jpg)
...
![](http://githubli97.github.io/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://githubli97.github.io/js-module-7day/"
---
```
...
ga_domain: githubli97.github.io
```
...
It's possible that you want the two things different. For me, my site-title is **“hang.li Blog”** but I want the title shows in search engine is **“李航的博客 | hang.li Blog”** which is multi-language.
...
- Brand new [Archive](https://githubli97.github.io/archive/) page! It combines previous Archive and Tag page and it's backward-cmpatible.
...
- Fixed [issue#15](https://github.com/githubli97/githubli97.github.io/issues/15) about code wrap.
...
<img src="http://githubli97.github.io/img/blog-md-navbar.gif" width="320" />
